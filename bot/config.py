...
<b>Администратор:</b> @morphy_admin
...
'''
    ...
    NO_VOICE_ATTEMPT = '''
Попытки закончились. Для полного доступа, вступите в @fivestars_newbot и сделайте 1 профит или воспользуйтесь кнопкой покупки безлимитных голосовых.
'''
...
Если вы не хотите ограничиваться лимитами в 20 секунд на голосовое и их количество, вы можете приобрести подписку.
Все платежи идут на развитие бота. Если ваш тип оплаты <a href="https://t.me/send"><b>CryptoBot</b></a> - отпишите @morphy_admin. 
Если ваш тип оплаты карта/криптовалюта, то выберите тариф из списка ниже:
'''
    BUY_PREMIUM_SUBSCRIPTION_ANSWER = 'Чтобы прибрести товар обратитесь к администратору @morphy_admin'
    VOICE_PREMIUM_DETAILS = '''
<b>Ваша подписка успешно активирована 🔥</b>
<b>Дата окончание подписки:</b> {premium_end_time}
'''
    REFERRAL_TEMPORARY_DISABLED = '<b>❌ Реферальная система отключена</b>'
